/*
 * Public API Surface of angularx-datatable
 */
...
export * from './lib/angularx-datatable-tailwind/angularx-datatable-tailwind.component';
export * from './lib/angularx-base-datatable.component';
